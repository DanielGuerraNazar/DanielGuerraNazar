...
## 💻 Sobre mim
* 🔬 Desenvolvendo projetos de **Modelagem Computacional** para cálculo e análise de incertezas na produção de Hidrogênio Verde (H2V).
* 🤖 Experiência prática com prototipagem eletrônica, desenhando circuitos e programando microcontroladores como **Arduino** e **ESP32**.
* 📚 Aplicando conceitos de cálculo, álgebra linear, metrologia e normas técnicas (como a NBR 5410) para solucionar problemas reais de engenharia.
* 💡 Sempre em busca de unir hardware e software para criar soluções eficientes.
...
![Fusion 360](https://img.shields.io/badge/Fusion_360-F96716?style=for-the-badge&logo=autodesk&logoColor=white)
